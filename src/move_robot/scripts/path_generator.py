...
class path_planning():
    ...
    def __init__(self):
        ...
        self.start_x = int(input("Start X: "))
        self.start_y = int(input("Start Y: "))
        self.start_node = (self.start_x, self.start_y)
        print("End Co-ordinates: ")
        self.end_x = int(input("End X: "))
        self.end_y = int(input("End Y: "))
        self.end_node = (self.end_x, self.end_y)
        self.start_dir = input("Start Direction: ")
        self.end_dir = input("End Direction: ")
        # self.a_star()
